...
def display_primitive_screen():
    ...
    msg_classic.set_msg(SCREEN, (450, 450))
    msg_timer.set_msg(SCREEN, (480, 550))
    msg_arcade.set_msg(SCREEN, (450, 650))
...
def display_game_over_screen():
    ...
    msg_rcrecord = Message(WHITE, big_font, f"recent_record : {recordBook.record_dic['recent_record']}")
    msg_bstrecord = Message(WHITE, big_font, f"best_record : {recordBook.record_dic['best_record']}")
...
def draw_buttons():
    ...
    if not game_end:
        ...
        yes_button = Block(WHITE, Rect(80, 580, 150, 60))
        no_button = Block(WHITE, Rect(500, 580, 150, 60))
