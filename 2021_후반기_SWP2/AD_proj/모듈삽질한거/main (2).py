...
def display_game_screen():
    global start_tick, elapsed_time, time_limit, BLOCKS, SCREEN, game_start, score, heart, curr_stage, BLOCKS, BALL, PADDLE
    ...
    check_movement(game_start, score, heart, curr_stage, BLOCKS, BALL, PADDLE)
    check_game_over()
...
def object_initialize():
    global game_start, score, heart, curr_stage, time_limit, start_tick, elapsed_time, BLOCKS, BALL, PADDLE
